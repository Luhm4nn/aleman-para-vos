...
2. [Estructura del panel](#2-estructura-del-panel)
3. [Gestión de Inscripciones](#3-gestión-de-inscripciones)
4. [Gestión de Cursos y Dictados](#4-gestión-de-cursos-y-dictados)
5. [Gestión de Consultas](#5-gestión-de-consultas)
6. [Novedades](#6-novedades)
7. [Testimonios](#7-testimonios)
8. [Materiales](#8-materiales)
9. [Datos de cobro](#9-datos-de-cobro)
...
1. Ingresar a [alemanparavos.com/login](https://alemanparavos.com/login).
2. Completar email y contraseña del administrador.
3. Hacer clic en **Ingresar**.

Si los datos son correctos, serás redirigida al panel de administración.

### Cierre de sesión automático

La sesión expira automáticamente tras **30 minutos de inactividad**. Al intentar realizar cualquier acción, el sistema mostrará un mensaje indicando que la sesión venció y redirigirá al login. Esto es una medida de seguridad, no un error.

### Cerrar sesión manualmente

Usar el botón **Cerrar sesión** en la esquina superior del panel. Se recomienda hacerlo siempre al terminar, especialmente en computadoras compartidas.

### Posibles problemas al iniciar sesión

| Situación | Causa probable | Solución |
|---|---|---|
| "Credenciales inválidas" | Email o contraseña incorrectos | Verificar mayúsculas y espacios en blanco |
| El botón no responde | Demasiados intentos en poco tiempo | Esperar 1 minuto (el sistema tiene protección anti-fuerza bruta) |
| Pantalla en blanco o error de red | El servidor puede estar iniciando | Esperar 30-60 segundos y recargar. El servidor entra en modo sleep tras inactividad prolongada |
| "No autorizado" después de un rato | La sesión expiró por inactividad | Volver a iniciar sesión |

> **Contraseña olvidada:** Contactar al administrador técnico para resetearla.

---

## 2. Estructura del panel

El panel está organizado en pestañas accesibles desde el menú superior:

| Pestaña | Función |
|---|---|
| **Inscripciones** | Gestión de alumnos inscriptos (pestaña por defecto) |
| **Cursos** | Configuración de cursos, dictados y cupos |
| **Consultas** | Mensajes recibidos desde el formulario de contacto |
| **Novedades** | Publicación de anuncios en la web |
| **Testimonios** | Gestión de comentarios de alumnos |
| **Materiales** | Recursos descargables para alumnos |
| **Transferencia** | Datos bancarios para el formulario de inscripción |

---

## 3. Gestión de Inscripciones

Esta es la sección más usada. Aquí se gestionan todos los alumnos que se anotan a través de la web o que se registran manualmente.

### Estados de una inscripción

| Estado | Significado |
|---|---|
| **Pendiente** | El alumno completó el formulario web. Queda en espera de confirmación de pago. |
| **Confirmada** | El alumno fue aceptado oficialmente. Se le envió un mail de confirmación automático. |

### Ver inscripciones

Las inscripciones se muestran en una lista con nombre, apellido, email, curso/dictado, fecha y estado. Se pueden filtrar por estado para ver solo pendientes o confirmadas.

### Confirmar una inscripción

1. Ubicar al alumno en la lista de **Pendientes**.
2. Hacer clic en el ícono de **confirmar** (sobre).
3. El sistema envía automáticamente un mail de confirmación al alumno con los detalles del curso.
4. La inscripción pasa al estado **Confirmada** y el cupo del dictado se reduce en 1.

> Si el envío del mail falla por un problema de conexión, la inscripción igual queda confirmada en el sistema. El mail puede reenviarse si es necesario.

### Ver comprobante de pago

Si el alumno adjuntó un comprobante al inscribirse, aparecerá el ícono para **ver comprobante**. Hacer clic abre el archivo en una nueva pestaña.

### Registrar una inscripción manualmente

Cuando un alumno se contacta por fuera de la web (WhatsApp, teléfono, Instagram):

1. Hacer clic en **+ Nueva Inscripción**.
2. Completar nombre, apellido, email y opcionalmente teléfono.
3. Seleccionar el **Curso** y luego el **Dictado** (horario específico).
4. Guardar.

Las inscripciones manuales se crean directamente con estado **Confirmada** y el cupo se descuenta automáticamente.
...
Si el alumno tenía estado **Confirmada**, el cupo del dictado se libera automáticamente. Esta acción no puede deshacerse.

### Posibles errores

| Mensaje | Causa | Solución |
|---|---|---|
| "No quedan cupos disponibles" | El dictado está completo | Verificar el dictado o aumentar cupos en la sección Cursos |
| "Inscripción no encontrada" | El registro fue eliminado previamente | Recargar la página |
| "Esta inscripción ya fue confirmada" | Se intentó confirmar una ya confirmada | No requiere acción, ya está en orden |
| "No autorizado" | La sesión expiró | Volver a iniciar sesión |
| Error general al guardar | Problema de conexión o servidor | Esperar unos segundos y reintentar |

---

## 4. Gestión de Cursos y Dictados

### Concepto clave: Curso vs. Dictado

- **Curso**: El producto. Define nombre, descripción, contenidos y precios. Ejemplo: _Alemán Nivel A1_.
- **Dictado**: Una instancia concreta del curso. Define horarios, fechas, días y cupos. Un mismo curso puede tener varios dictados simultáneos (grupo mañana y grupo tarde).
...
2. Completar:
   - **Título**
   - **Descripción**
   - **Ítems incluidos** (con el botón "+ Agregar ítem")
   - **Valor en pesos** (alumnos nacionales)
   - **Valor internacional** (alumnos del exterior)
   - **Valor en dólares**
3. Guardar.
...
Editar un curso no afecta a las inscripciones ya existentes.

### Activar / desactivar un curso

El toggle **Activo** controla si el curso aparece en el sitio público. Desactivarlo lo oculta de la web sin eliminarlo ni afectar a los alumnos ya inscriptos.

### Crear un dictado

1. Dentro del curso, hacer clic en **+ Nuevo Dictado**.
2. Completar:
...
Cada dictado muestra `X / Y alumnos` (inscripciones confirmadas / cupos totales). Se actualiza automáticamente al confirmar o eliminar inscripciones. Cuando el cupo está lleno, el formulario web bloquea nuevas inscripciones para ese dictado.

### Eliminar un curso o dictado

> Eliminar un dictado borra también todas sus inscripciones asociadas.  
> Eliminar un curso borra todos sus dictados e inscripciones.  
> Estas acciones son irreversibles. Considerar desactivar antes de eliminar.

### Posibles errores

| Mensaje | Causa | Solución |
|---|---|---|
| "Curso no encontrado" | El registro fue eliminado | Recargar la lista |
| "Dictado no encontrado" | El dictado fue eliminado | Recargar la lista |
| "No autorizado" | Sesión expirada | Volver a iniciar sesión |

---

## 5. Gestión de Consultas

Aquí llegan los mensajes del formulario de contacto del sitio.

### Estados de una consulta

| Estado | Significado |
|---|---|
| **Pendiente** | Recibida, aún no revisada |
| **Revisada** | Leída |
| **Contactada** | Se respondió o contactó al remitente |

### Cambiar el estado

Usar el selector desplegable en cada tarjeta. El cambio se guarda automáticamente.

### Filtrar consultas

Los botones de filtro (Todas / Pendientes / Revisadas / Contactadas) permiten organizar el seguimiento.

### Comportamiento del formulario público

- El mismo email no puede enviar más de una consulta en **24 horas**. El sistema lo bloquea automáticamente.
- Hay un límite de **10 consultas por hora por IP** para prevenir spam.

### Posibles errores

| Mensaje | Causa | Solución |
|---|---|---|
| "Consulta no encontrada" | Ya fue eliminada | Recargar la página |
| "No autorizado" | Sesión expirada | Volver a iniciar sesión |
...
Las novedades aparecen en la sección correspondiente del sitio, como tarjetas con imagen, título y descripción.

### Crear una novedad

1. Hacer clic en **+ Nueva Novedad**.
2. Completar título, descripción e imagen (obligatoria).
3. Guardar.
...
Al subir una nueva imagen en la edición, la imagen anterior se elimina automáticamente del servidor.

### Eliminar una novedad

La novedad y su imagen se eliminan permanentemente.

### Posibles errores

| Mensaje | Causa | Solución |
|---|---|---|
| "La imagen es requerida" | Se intentó guardar sin imagen | Seleccionar un archivo |
| "Formato de imagen no válido" | Se subió un PDF, GIF u otro formato | Usar JPEG, PNG o WebP |
| "La imagen es demasiado grande" | El archivo supera 5 MB | Comprimir la imagen antes de subir |
| "Novedad no encontrada" | El registro fue eliminado | Recargar la lista |

---

## 7. Testimonios

Los testimonios activos aparecen en la sección de testimonios del sitio público.

### Crear un testimonio

1. Hacer clic en **+ Nuevo Testimonio**.
2. Completar nombre completo del alumno y texto.
3. Guardar. Queda **activo** (visible) por defecto.

### Activar / desactivar

El toggle de visibilidad muestra u oculta el testimonio en el sitio sin borrarlo.

### Editar

Permite corregir errores ortográficos o actualizar el texto.

### Posibles errores

| Mensaje | Causa | Solución |
|---|---|---|
| "Testimonio no encontrado" | El registro fue eliminado | Recargar la lista |
| "No autorizado" | Sesión expirada | Volver a iniciar sesión |
...
Archivos (PDF, imágenes, documentos) disponibles para los alumnos desde el sitio.

### Subir un material

1. Hacer clic en **+ Nuevo Material**.
2. Completar el nombre descriptivo.
3. Seleccionar el archivo y guardar.

Los archivos se almacenan en la nube y quedan accesibles mediante un enlace público.

### Eliminar un material

El archivo se elimina tanto del sistema como del almacenamiento en la nube.

### Posibles errores

| Mensaje | Causa | Solución |
|---|---|---|
| "Error al subir el archivo" | Fallo de conexión con el servicio de almacenamiento | Reintentar en unos segundos |
| "Material no encontrado" | El registro fue eliminado | Recargar la lista |

---

## 9. Datos de cobro

Gestiona la información bancaria que se incluye automáticamente en el mail de notificación que recibe el alumno al inscribirse.

### Tipos de cuenta

| Tipo | Uso |
|---|---|
| **Nacional** | Transferencia bancaria en Argentina |
| **Internacional** | Alumnos del exterior u otros métodos |

### Editar datos

1. Hacer clic en el ícono de editar.
2. Actualizar alias, CVU y nombre de la cuenta.
3. Guardar.

Los cambios se reflejan en los mails enviados a partir de ese momento. Los mails ya enviados no se modifican retroactivamente.
...
|---|---|---|
| "No autorizado" | Token JWT expirado o inválido | Cerrar sesión y volver a ingresar |
| Redirección automática al login | Sesión expiró por inactividad (30 min) | Iniciar sesión nuevamente |
| No puedo iniciar sesión | Demasiados intentos fallidos (límite: 5 por minuto) | Esperar 1 minuto y reintentar |

### Errores de recursos

| Mensaje / Síntoma | Causa | Solución |
|---|---|---|
| "No encontrado" | El elemento fue eliminado | Recargar la página |
| La lista aparece vacía | Sin registros o error de carga | Verificar conexión y recargar |

### Errores de validación

| Mensaje / Síntoma | Causa | Solución |
|---|---|---|
| "No quedan cupos disponibles" | Dictado completo | Aumentar cupos o seleccionar otro dictado |
| "Ya has enviado una consulta recientemente" | Mismo email en menos de 24 h | Esperar el período indicado |
| "Esta inscripción ya fue confirmada" | Doble confirmación accidental | No requiere acción |
| Campos marcados en rojo | Datos faltantes o con formato incorrecto | Completar los campos señalados |

### Problemas de velocidad o disponibilidad

| Síntoma | Causa probable | Solución |
|---|---|---|
| El panel tarda en cargar la primera vez | El servidor estaba inactivo | Esperar 30-60 segundos y recargar |
| Las imágenes no cargan | Lentitud en el servicio de almacenamiento | Recargar la página |
| Error 500 o "Error inesperado del servidor" | Falla interna | Recargar; si persiste, contactar soporte técnico |

---

> Para soporte técnico o reseteo de contraseña, contactar al administrador del sistema.
